...
loadCldr(
  numberingSystems['default' as keyof typeof numberingSystems],
  gregorian['default' as keyof typeof gregorian],
  numbers['default' as keyof typeof numbers],
  timeZoneNames['default' as keyof typeof timeZoneNames]
);
L10n.load({
  pt: {
    schedule: {
      ...
      previous: 'Anterior',
      next: 'Próximo',
      timelineDay: 'Alocação Diária',
      timelineWeek: 'Alocação Semanal',
      timelineWorkWeek: 'Alocação Semana Útil',
